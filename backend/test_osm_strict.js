...
async function test() {
  ...
  try {
    ...
    const filtered = unique.filter(p => {
      ...
      // Susanoğlu gibi isimler için ek kontrol yapalım, eger type=beach ise tamam,
      // değilse adında kesin plaj/koy vs geçmeli.
      const hasKeyword = validKeywords.some(kw => lowerName.includes(kw));
